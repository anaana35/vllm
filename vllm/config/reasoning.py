...
class ReasoningConfig:
    ...
    think_ending_token_ids: Optional[list[int]] = None
    think_reasoning_token_ids: Optional[list[int]] = None
    ...
    def initialize_token_ids(self, model_config: ModelConfig) -> None:
        ...
        if self.think_start_str is not None and self.think_end_str is not None:
            ...
            self.think_ending_token_ids = tokenizer.convert_tokens_to_ids(self.think_ending_tokens)

            self.think_reasoning_token_ids = tokenizer.convert_tokens_to_ids(self.think_reasoning_tokens)